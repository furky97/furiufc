...
const data = {
  rankings: [
    ...
    { player: 'Tahir_UFC', wins: 4, draws: 0, losses: 2 },
    ...
    { player: 'zFreezy', wins: 2, draws: 0, losses: 3 },
    { player: 'thegame2621', wins: 1, draws: 0, losses: 3 },
    { player: 'Ronaldinho', wins: 0, draws: 0, losses: 4 },
    { player: 'Bronxs_MMA', wins: 1, draws: 0, losses: 2 },
    { player: 'Rebell', wins: 4, draws: 0, losses: 1 },
    ...
    { player: 'Arezmaa', wins: 2, draws: 0, losses: 2 },
    { player: 'RushMMA', wins: 2, draws: 0, losses: 3 },
    { player: 'Seyiito', wins: 2, draws: 0, losses: 3 },
    { player: 'alpi', wins: 1, draws: 0, losses: 4 },
    // { player: 'AlpiQLF', wins: 0, draws: 0, losses: 1 },
    { player: 'ANNOYIING', wins: 2, draws: 0, losses: 1 },
